      ...
      >
          ...
          {!isSidebarCollapsed && (
            ...
            >
              ...
              <div className="min-w-0">
                <p className="text-[13px] font-bold text-white truncate leading-tight font-display">{user?.name || 'User'}</p>
                <p className="text-[11px] text-teal truncate leading-tight font-mono mt-0.5">{user?.plan || 'free'} plan</p>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
        {!isSidebarCollapsed && (
          <div className="px-4 pb-4">
            <button onClick={logout} className="w-full btn-secondary text-[12px] justify-center">Log out</button>
          </div>
        )}
      </motion.aside>
              ...
              <div className="p-4 border-t border-white/[0.04]">
                <div className="flex items-center gap-3 p-3 bg-white/5 rounded-xl border border-white/10">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[10px] text-teal truncate">{user?.plan || 'free'} plan</p>
                  </div>
                </div>
                <button onClick={logout} className="w-full btn-secondary text-[12px] justify-center mt-3">Log out</button>
              </div>
            </motion.aside>
          </>
        )}
