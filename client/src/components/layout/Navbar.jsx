            ...
            {!isAppRoute ? (
              <>
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Link to={ctaTo} className="relative group overflow-hidden rounded-xl bg-white text-black px-5 py-2.5 flex items-center gap-2 font-semibold text-[13px] shadow-[0_0_20px_rgba(255,255,255,0.15)] hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] transition-shadow">
                    <span className="relative z-10 flex items-center gap-1.5 font-display tracking-wide">
                      {user ? 'Open Dashboard' : 'Get Started'} <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-1 transition-transform" />
                    </span>
            ...
            <div className="px-6 space-y-6 relative z-10 w-full max-w-sm mx-auto">
              ...
              {!isAppRoute && (
                <div className="overflow-hidden mt-12 pt-8 border-t border-white/10">
                  ...
                  >
                    <Link to={ctaTo} className="flex items-center justify-between w-full p-6 rounded-2xl bg-gradient-to-r from-primary/20 to-teal/20 border border-white/10 group relative overflow-hidden">
                      ...
                      <span className="text-xl font-display font-bold text-white flex items-center gap-3 relative z-10">
                        <Sparkles className="w-6 h-6 text-teal" /> {ctaLabel}
                      </span>
