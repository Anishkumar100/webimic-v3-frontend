      ...
      <motion.div className="max-w-6xl mx-auto px-5 sm:px-6 relative z-10" style={{ y, opacity }}>
        ...
        <div className="flex flex-col items-center text-center mb-32 relative">
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Link to="/app" className="group relative inline-flex items-center justify-center overflow-hidden rounded-full p-[2px] bg-gradient-to-r from-primary via-teal to-primary background-animate shadow-[0_0_40px_rgba(124,111,255,0.3)]">
              ...
              <div className="relative inline-flex items-center gap-3 px-8 py-4 sm:px-10 sm:py-5 bg-[#06060e] rounded-full transition-all duration-300 group-hover:bg-transparent">
                <span className="text-white font-display font-bold text-lg sm:text-xl tracking-wide">Get Started for Free</span>
          ...
          {cols.map((col) => (
            <div key={col.title}>
              ...
              <ul className="space-y-5">
                {col.links.map((link) => (
                  <li key={link.label}>
                    <Link to={link.to} className="group flex items-center text-[15px] text-muted hover:text-white transition-colors font-body relative w-fit">
