            ...
            <div className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[rgba(10,10,18,0.4)] p-6 space-y-5">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" defaultValue="TheWebytes" className="w-full bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.06)] rounded-lg px-4 py-2.5 text-[13px] text-text focus:outline-none focus:border-[rgba(124,111,255,0.3)] transition-all" />
                </div>
                <div>
                  <label className="block text-[11px] text-muted mb-1.5 uppercase tracking-wider">Email</label>
                  <input type="email" defaultValue="team@thewebytes.com" className="w-full bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.06)] rounded-lg px-4 py-2.5 text-[13px] text-text focus:outline-none focus:border-[rgba(124,111,255,0.3)] transition-all" />
                </div>
              </div>
              <motion.button className="btn-primary text-[12px]" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>Save Changes</motion.button>
            </div>
          )}
            ...
            <div className="space-y-5">
              <div className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[rgba(10,10,18,0.4)] p-6">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <p className="text-base font-display font-bold text-text">Pro Plan</p>
                    <p className="text-[13px] text-muted">$29/month &middot; Renews May 15, 2026</p>
                  </div>
                  <motion.button className="btn-secondary text-[12px]" whileHover={{ scale: 1.02 }}>Change Plan</motion.button>
                </div>
                ...
                <p className="text-[11px] text-muted mt-2">67 of 100 jobs used this month</p>
              </div>
              {settingsBilling && (
